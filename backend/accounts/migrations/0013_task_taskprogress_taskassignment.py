...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0012_alter_projectmember_options_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.tasktype')),
            ],
        ),
        migrations.CreateModel(
            name='TaskProgress',
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='progress_logs', to='accounts.task')),
